...
var Spell = function (_Phaser$Sprite) {
  ...
  function Spell(_ref) {
    ...
    var _this = _possibleConstructorReturn(this, (Spell.__proto__ || Object.getPrototypeOf(Spell)).call(this, game, 0, 0, asset, frame));
  ...
  _createClass(Spell, [{
    ...
    value: function update() {
      _get(Spell.prototype.__proto__ || Object.getPrototypeOf(Spell.prototype), 'update', this).call(this);
      this.y -= 25;
    }
  }, {
    key: 'onHit',
    value: function onHit(source) {
      this.game.sound.play('hit-se', 100, false);
      this.kill();
    }
  }]);
...
var PickUps = function (_Phaser$Sprite) {
    _inherits(PickUps, _Phaser$Sprite);

    function PickUps(_ref) {
        var game = _ref.game,
            x = _ref.x,
            y = _ref.y,
            type = _ref.type,
        ...
        _classCallCheck(this, PickUps);

        var _this = _possibleConstructorReturn(this, (PickUps.__proto__ || Object.getPrototypeOf(PickUps)).call(this, game, x, y, 'pickups', type));
...
// Using Unique Frame as Constant Enum


exports.default = PickUps;
PickUps.POWER_UPS = 42;
PickUps.HEALTH_UPS = 84;
PickUps.SCORE_UPS = 87;
PickUps.BOMB_UPS = 218;
PickUps.ALL_UPS = [PickUps.POWER_UPS, PickUps.POWER_UPS, PickUps.POWER_UPS, PickUps.HEALTH_UPS, PickUps.SCORE_UPS, PickUps.SCORE_UPS, PickUps.SCORE_UPS, PickUps.SCORE_UPS, PickUps.SCORE_UPS, PickUps.SCORE_UPS, PickUps.SCORE_UPS, PickUps.SCORE_UPS, PickUps.BOMB_UPS];
...
module.exports = __webpack_require__(/*! C:\Users\Chivalry\WebstormProjects\phaser-es6-webpack-master\src\main.js */336);
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(/*! ./_hide */ 13)(proto, TO_PRIMITIVE, __webpack_require__(/*! ./_date-to-primitive */ 218));
...
var _boot = __webpack_require__(/*! ./states/boot */ 341);

var _boot2 = _interopRequireDefault(_boot);

var _title = __webpack_require__(/*! ./states/title */ 342);
...
var _game_over = __webpack_require__(/*! ./states/game_over */ 351);

var _game_over2 = _interopRequireDefault(_game_over);

var _config = __webpack_require__(/*! ./config */ 129);
...
var Game = function (_Phaser$Game) {
  ...
  function Game() {
    ...
    _this.state.add('GameOver', _game_over2.default, false);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    key: 'preload',
    value: function preload() {
      this.load.image('title', 'assets/images/crystal.png');

      this.load.image('mage', 'assets/images/hero.png');

      this.load.audio('theme', 'assets/bgm/theme.m4a');
    }
  }, {
    key: 'create',
    value: function create() {
      ...
      this.game.sound.play('theme', 100, true);

      // Setting up title background image and dimension
      var img = this.game.add.image(w / 2, h / 2, 'title');
      (0, _utils.centerGameObjects)([img]);
      img.scale.setTo(1.6, 1.25);

      // Set up Title Text, and dimension
      var bannerText = 'Danmaku';
      var banner = this.add.text(w / 2, 120, bannerText, {
        font: '40px Bangers',
        fill: '#bf322b',
        smoothed: false,
        shadowColor: '#ffffff'
      ...
      this.mage = this.game.add.image(this.world.centerX, this.world.centerY, 'mage');
      (0, _utils.centerGameObjects)([this.mage]);

      banner.padding.set(10, 16);
      banner.anchor.setTo(0.5);

      // Set up instruction Text
      var instructionText = 'Press SPACE bar to continue...';

      /**
       * @type {Phaser.Text}
       */
      this.instruction = this.add.text(w / 2, h - 160, instructionText, {
        font: '32px Bangers',
        fill: '#bf9411',
        smoothed: false
      });
      ...
      this.fireKey = this.game.input.keyboard.addKey(_phaser2.default.Keyboard.SPACEBAR);
    }
  }, {
    key: 'update',
    value: function update() {
      ...
      this.mage.scale.x = 2 + Math.sin(this.count) * 0.04;
      this.mage.scale.y = 2 + Math.cos(this.count) * 0.04;

      this.count += 0.1;

      // Update movement of instruction text
      this.instruction.x = (this.instruction.x + 1) % this.game.width;
    }
  }]);
...
var _player = __webpack_require__(/*! ../sprites/player */ 344);

var _player2 = _interopRequireDefault(_player);

var _enemy_group = __webpack_require__(/*! ../groups/enemy_group */ 347);

var _enemy_group2 = _interopRequireDefault(_enemy_group);

var _effect_animation = __webpack_require__(/*! ../sprites/effect_animation */ 349);

var _effect_animation2 = _interopRequireDefault(_effect_animation);

var _pickup_group = __webpack_require__(/*! ../groups/pickup_group */ 350);

var _pickup_group2 = _interopRequireDefault(_pickup_group);

var _pickup = __webpack_require__(/*! ../sprites/pickup */ 132);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    key: 'preload',
    value: function preload() {
      this.load.spritesheet('actor', 'assets/characters/hero.png', 32, 48);
      this.load.spritesheet('ghost', 'assets/characters/ghoust.png', 100, 100);
      this.load.spritesheet('ghost-stk', 'assets/characters/ghoust-atk.png', 100, 100);
      this.load.spritesheet('harpia', 'assets/characters/harpia.png', 100, 100);
      this.load.spritesheet('vampire', 'assets/characters/vampire.png', 100, 100);

      this.load.spritesheet('light1', 'assets/animations/light1.png', 75, 75);
      this.load.spritesheet('light3', 'assets/animations/light3.png', 100, 100);
      this.load.spritesheet('fire3', 'assets/animations/fire3.png', 48, 48);
      this.load.spritesheet('explode', 'assets/animations/explode.png', 192, 192);
      this.load.spritesheet('good', 'assets/animations/good.png', 192, 192);

      this.load.image('fog', 'assets/images/fog.png');
      this.load.image('background', 'assets/images/background.png');
      this.load.image('ui', 'assets/images/ui.png');

      this.load.spritesheet('pickups', 'assets/pickups/IconSet.png', 32, 32);

      this.load.audio('bgm', 'assets/bgm/battle.m4a');

      this.load.audio('coin-se', 'assets/se/coin.ogg');
      this.load.audio('shoot-se', 'assets/se/shoot.ogg');
      this.load.audio('hit-se', 'assets/se/hit.ogg');
    }
  }, {
    key: 'create',
    value: function create() {
      this.game.sound.stopAll();
      this.game.sound.play('bgm', 75, true);

      this.game.physics.startSystem(_phaser2.default.Physics.ARCADE);
      this.game.physics.arcade.gravity.setTo(0, 100);

      this.createBackground();
      this.spawnPlayer();
      this.spawnEnemies();

      this.pickups = new _pickup_group2.default({
        game: this.game
      });
    ...
    value: function createUI() {
      this.game.add.image(0, 0, 'ui');
      this.scoreText = this.game.add.text(132, 17, '000000');
      this.powerText = this.game.add.text(375, 17, '000000');
    }
    ...
    value: function createBackground() {
      this.background = this.game.add.tileSprite(0, 0, 816, 816, 'background');
    }
    ...
    value: function spawnPlayer() {
      this.player = new _player2.default({
        ...
        y: this.world.height - this.world.centerY / 4
      });
    ...
    value: function spawnEnemies() {
      this.enemyGroup = new _enemy_group2.default({ game: this.game, player: this.player });
      this.game.add.existing(this.enemyGroup);

      this.enemyGroup.children.forEach(function (child) {
        child.body.allowGravity = false;
      });
    }
  }, {
    key: 'playAnimationAt',
    value: function playAnimationAt(x, y) {
      var anime = new _effect_animation2.default({
        game: this.game,
        asset: 'explode',
        frames: [0, 1, 2, 3],
        frameRate: 5
      });
      this.game.add.existing(anime);
      anime.x = x;
      anime.y = y;
      anime.scale.setTo(0.3);
      anime.alpha = 0.3;
    }
  }, {
    key: 'onEnemyDie',
    value: function onEnemyDie(source) {
      source.kill();
    }
  }, {
    key: 'update',
    value: function update() {
      this.background.tilePosition.y += 2.5;

      this.game.physics.arcade.overlap(this.player.primaryEmitter, this.enemyGroup, this.onBulletCollision, null, this);

      this.game.physics.arcade.overlap(this.player.secondaryEmitter, this.enemyGroup, this.onBulletCollision, null, this);

      this.game.physics.arcade.overlap(this.player, this.enemyGroup, this.onCharacterCollision, null, this);

      this.game.physics.arcade.overlap(this.player, this.pickups, this.onPickupCollision, null, this);

      // Increasing
      this.counter++;
      if (this.counter > this.nextWave) {
        this.increaseChallenge();
        this.counter = 0;
      }
      ...
      this.shouldSpawnPickup();
    }

    /**
     * TODO: fix this very very BAD code
     */

  }, {
    key: 'shouldSpawnPickup',
    value: function shouldSpawnPickup() {
      if (window.shouldSpawnPickup[0] !== 0 && window.shouldSpawnPickup[1] !== 0) {
        this.pickups.spawnPickup(window.shouldSpawnPickup[0], window.shouldSpawnPickup[1]);
        window.shouldSpawnPickup = [0, 0];
      }
    }
    ...
    key: 'onPickupCollision',
    value: function onPickupCollision(first, second) {
      var player = first;
      var type = second.type;
      if (first instanceof _player2.default) {
        second.kill();
      } else {
        first.kill();
        player = second;
      ...
      this.game.add.existing(anime);
      anime.scale.setTo(0.5);
      anime.x = player.x;
      anime.y = player.y;

      if (type === _pickup2.default.POWER_UPS) {
        this.player.power++;
      } else if (type === _pickup2.default.SCORE_UPS) {
        this.score += 2500;
      } else {
        this.score += 1000;
      }

      this.game.sound.play('coin-se', 100, false);
    }
    ...
    value: function increaseChallenge() {
      this.enemyGroup.addMoreEnemy();
    }
    ...
    value: function onBulletCollision(first, second) {
      this.playAnimationAt(first.x, first.y);
      first.onHit(second);
      second.onHit(first);
    }
    ...
    key: 'onCharacterCollision',
    value: function onCharacterCollision(first, second) {
      this.playAnimationAt(first.x, first.y);
      first.kill();
      second.kill();
...
var _spell_emitter = __webpack_require__(/*! ../groups/spell_emitter */ 345);

var _spell_emitter2 = _interopRequireDefault(_spell_emitter);

var _focus_emitter = __webpack_require__(/*! ../groups/focus_emitter */ 346);

var _focus_emitter2 = _interopRequireDefault(_focus_emitter);
...
var Player = function (_Phaser$Sprite) {
  ...
  function Player(_ref) {
    ...
    // spritesheet('actor', 'assets/characters/hero.png', 32, 48)

    // Player Game Attributes
    var _this = _possibleConstructorReturn(this, (Player.__proto__ || Object.getPrototypeOf(Player)).call(this, game, x, y, 'actor'));

    _this.movementSpeed = 300;
    _this.fireRate = 75; // 50 for focused
    _this.life = 3;
    _this.power = 0;

    // Setup character object property
    _this.anchor.setTo(0.5);

    _this.moving = false;
    _this.direction = 8;
    _this.initializeEmitters(game);

    _this.initializeAnimation();
    _this.initializeInput();

    _this.animations.play('up');
  ...
  _createClass(Player, [{
    key: 'initializeEmitters',
    value: function initializeEmitters() {
      // Weapon 1
      this.primaryEmitter = new _spell_emitter2.default({
        game: this.game,
        fireRate: this.fireRate
      });
      this.game.add.existing(this.primaryEmitter);

      // Weapon 2, fired when shifting
      this.secondaryEmitter = new _focus_emitter2.default({
        game: this.game,
        fireRate: this.fireRate / 1.5
      });
      this.game.add.existing(this.secondaryEmitter);

      this.currentEmitter = this.primaryEmitter;
    }
    ...
    value: function initializeAnimation() {
      var _this2 = this;

      var FRAME_RATE = 5;
      this.animations.add('up', [12, 13, 14, 15], FRAME_RATE, true);
      var left = this.animations.add('left', [4, 5, 6, 7], FRAME_RATE, false);
      var right = this.animations.add('right', [8, 9, 10, 11], FRAME_RATE, false);

      left.onComplete.add(function () {
        _this2.animations.stop();
        _this2.animations.play('up');
      });
    ...
    value: function initializeInput() {
      ...
      this.dashKey = this.game.input.keyboard.addKey(_phaser2.default.Keyboard.SHIFT);
      this.fireKey = this.game.input.keyboard.addKey(_phaser2.default.Keyboard.Z);
      this.bombKey = this.game.input.keyboard.addKey(_phaser2.default.Keyboard.X);

      this.cursors.left.onDown.add(function () {
        _this3.animations.stop();
        _this3.animations.play('left');
      });
      this.cursors.right.onDown.add(function () {
        _this3.animations.stop();
        _this3.animations.play('right');
      });
    }
  }, {
    key: 'gainLife',
    ...
    value: function updateInput() {
      var player = this;
      var cursors = this.cursors; // local alias

      this.updateMovementInput(player, cursors);

      if (player.fireKey.isDown) {
        player.currentEmitter.fire(this, this.getDamage());
      }
    }
    ...
    key: 'updateMovementInput',
    value: function updateMovementInput(player, cursors) {
      if (this.dashKey.isDown) {
        this.currentEmitter = this.secondaryEmitter;
      ...
      // Arcade Shooter Movement
      if (cursors.down.isDown) {
        player.body.velocity.y = this.movementSpeed;
        player.direction = 2;
        player.moving = true;
      }
      ...
      if (cursors.left.isDown) {
        player.body.velocity.x = -this.movementSpeed;
        player.direction = 4;
        player.moving = true;
      }
...
var _spell = __webpack_require__(/*! ../sprites/spell */ 131);
...
var SpellEmitter = function (_Phaser$Group) {
  _inherits(SpellEmitter, _Phaser$Group);

  function SpellEmitter(_ref) {
    var game = _ref.game,
        fireRate = _ref.fireRate;

    _classCallCheck(this, SpellEmitter);

    var _this = _possibleConstructorReturn(this, (SpellEmitter.__proto__ || Object.getPrototypeOf(SpellEmitter)).call(this, game, game.world, 'spell primaryEmitter', false, true, _phaser2.default.Physics.ARCADE));

    _this.nextFire = 0;
    _this.fireRate = fireRate;
    _this.updateOnlyExistingChildren = true;
    _this.alterSide = false;

    // Object Pool
    for (var i = 0; i < 64; ++i) {
      _this.add(new _spell2.default({
        game: game,
        asset: 'light1',
        frame: 12
      }), true);
  ...
  _createClass(SpellEmitter, [{
    key: 'update',
    value: function update() {
      _get(SpellEmitter.prototype.__proto__ || Object.getPrototypeOf(SpellEmitter.prototype), 'update', this).call(this);
    }
  }, {
    key: 'canFire',
    ...
    /**
     * @param source {Phaser.Sprite}
     * @param damage {number}
     */

  }, {
    key: 'fire',
    value: function fire(source, damage) {
      if (this.canFire()) {
        this.game.sound.play('shoot-se', 100, false);

        this.alterSide = !this.alterSide;

        var deltaX = this.alterSide ? 20 : -20;
        var x = source.x + deltaX;
        var y = source.y - 20;
...
exports.default = SpellEmitter;

/***/ }),
/* 346 */
/*!*************************************!*\
  !*** ./src/groups/focus_emitter.js ***!
  \*************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var FocusEmitter = function (_Phaser$Group) {
  _inherits(FocusEmitter, _Phaser$Group);

  function FocusEmitter(_ref) {
    var game = _ref.game,
        fireRate = _ref.fireRate;

    _classCallCheck(this, FocusEmitter);

    var _this = _possibleConstructorReturn(this, (FocusEmitter.__proto__ || Object.getPrototypeOf(FocusEmitter)).call(this, game, game.world, 'spell primaryEmitter', false, true, _phaser2.default.Physics.ARCADE));
  ...
  _createClass(FocusEmitter, [{
    key: 'update',
    value: function update() {
      _get(FocusEmitter.prototype.__proto__ || Object.getPrototypeOf(FocusEmitter.prototype), 'update', this).call(this);
    }
  }, {
    key: 'canFire',
    value: function canFire() {
    ...
    value: function fire(source, damage) {
      if (this.canFire()) {
        ...
        var deltaX = this.alterSide ? 10 : -10;
        var x = source.x + deltaX;
        var y = source.y - 20;
...
exports.default = FocusEmitter;

/***/ }),
/* 347 */
/*!***********************************!*\
  !*** ./src/groups/enemy_group.js ***!
  \***********************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var _enemy = __webpack_require__(/*! ../sprites/enemy */ 348);
...
var EnemyGroup = function (_Phaser$Group) {
  ...
  function EnemyGroup(_ref) {
    var game = _ref.game,
        player = _ref.player;

    _classCallCheck(this, EnemyGroup);

    var _this = _possibleConstructorReturn(this, (EnemyGroup.__proto__ || Object.getPrototypeOf(EnemyGroup)).call(this, game, game.world, 'spell primaryEmitter', false, true, _phaser2.default.Physics.ARCADE));

    _this.enableBody = true;
    _this.physicsBodyType = _phaser2.default.Physics.ARCADE;
    ...
    _this.enemies = [];
    for (var i = 0; i < 10; ++i) {
      _this.enemies.push(_this.createEnemy(50 + i * 75, 0));
    }
    return _this;
  }
  ...
  _createClass(EnemyGroup, [{
    key: 'createEnemy',
    value: function createEnemy(x, y) {
      var enemy = new _enemy2.default({
        game: this.game,
        x: x,
        y: y,
        asset: this.game.rnd.pick(EnemyGroup.ENEMY_KEYS),
        frame: 12,
        player: this.player
      });
      this.add(enemy);
      enemy.body.setSize(48, 48, 26, 26);
      return enemy;
    }
  }, {
    key: 'addMoreEnemy',
    value: function addMoreEnemy() {
      this.enemies.push(this.createEnemy(50 + 75, 0));
    }
    ...
    key: 'update',
    value: function update() {
      _get(EnemyGroup.prototype.__proto__ || Object.getPrototypeOf(EnemyGroup.prototype), 'update', this).call(this);
      // this.counter++

      var enemy = this.getFirstExists(false);
      if (enemy) {
        enemy.reset(this.game.rnd.realInRange(50, this.game.world.width - 50), 0);
      }
    }
  }]);
...
EnemyGroup.ENEMY_KEYS = ['ghost', 'ghost-stk', 'harpia', 'vampire'];
...
var Enemy = function (_Phaser$Sprite) {
  ...
  function Enemy(_ref) {
    ...
    _this.animations.add('moving', [0, 1, 2, 3]);
    _this.animations.play('moving', _this.game.rnd.integerInRange(3, 8), true);

    _this.outOfBoundsKill = true;
    _this.checkWorldBounds = true;

    // Enemy Attributes
    _this.speedX = _this.game.rnd.integerInRange(-4, 4);
    _this.speedY = _this.game.rnd.integerInRange(2, 7);
    _this.hitpoint = 100;
    return _this;
  }
  ...
  _createClass(Enemy, [{
    ...
    key: 'onHit',
    value: function onHit(source) {
      this.hitpoint -= source.dmg;
      if (this.hitpoint <= 0) {
        this.kill();

        if (this.game.rnd.integerInRange(1, 20) === 1) {
          // TODO: fix this very very BAD code
          window.shouldSpawnPickup = [source.x, source.y];
        }
      }
    }
  }]);
...
/* 349 */
/*!*****************************************!*\
  !*** ./src/sprites/effect_animation.js ***!
  \*****************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var EffectAnimation = function (_Phaser$Sprite) {
  _inherits(EffectAnimation, _Phaser$Sprite);

  function EffectAnimation(_ref) {
    var game = _ref.game,
        asset = _ref.asset,
        frames = _ref.frames,
        frameRate = _ref.frameRate;

    _classCallCheck(this, EffectAnimation);

    var _this = _possibleConstructorReturn(this, (EffectAnimation.__proto__ || Object.getPrototypeOf(EffectAnimation)).call(this, game, 0, 0, asset, frames[0]));

    _this.anchor.setTo(0.5);
    _this.exists = true;

    _this.animations.add('anime', frames, frameRate, false);
    _this.animations.play('anime', frameRate, false, true);
    return _this;
  }
...
exports.default = EffectAnimation;

/***/ }),
/* 350 */
/*!************************************!*\
  !*** ./src/groups/pickup_group.js ***!
  \************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var PickupGroup = function (_Phaser$Group) {
  _inherits(PickupGroup, _Phaser$Group);

  function PickupGroup(_ref) {
    var game = _ref.game;

    _classCallCheck(this, PickupGroup);

    var _this = _possibleConstructorReturn(this, (PickupGroup.__proto__ || Object.getPrototypeOf(PickupGroup)).call(this, game, game.world, 'spell primaryEmitter', false, true, _phaser2.default.Physics.ARCADE));
  ...
  _createClass(PickupGroup, [{
    key: 'spawnPickup',
    value: function spawnPickup(x, y) {
      var pickup = new _pickup2.default({
        game: this.game,
        x: x,
        y: y,
        type: this.game.rnd.pick(_pickup2.default.ALL_UPS),
        player: this.player
      });
      this.game.add.existing(pickup);
      pickup.body.velocity.y = -40;
...
exports.default = PickupGroup;

/***/ }),
/* 351 */
/*!*********************************!*\
  !*** ./src/states/game_over.js ***!
  \*********************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function preload() {
      ...
      this.load.audio('over_bgm', 'assets/bgm/defeat.ogg');
    }
  }, {
    key: 'create',
    value: function create() {
      var bg = this.game.add.image(this.game.world.centerX, this.game.world.centerY, 'over');
      (0, _utils.centerGameObjects)([bg]);

      this.game.sound.stopAll();
      this.game.sound.play('over_bgm', 75, false);
    }
  }]);
